...
import Stickermule from '../components/assets/sponsers/Stickermule_logo.png'
  ...
  return (
    <div className="sponsors" id="sponsors">
      ...
      <div className="silverImages">
        <a href="https://replit.com/"><img className="silver" id="diff" src={Replit} alt="REPLIT LOGO"></img></a>
      ...
      <div className="silverImages">
        <a href="https://rosenfeldmedia.com/"><img className="silver" id="diff" src={Rosenfeld} alt="ROSENFELD LOGO"></img></a>
