...
const FAQ = () => {
  const registrationAndEventDetails = [
    ...
    { question: "When will the hackathon take place?", answer: "ENGAGE 4.0 will be held on 22nd October - 23rd October 2024. So mark your calendars now." },
  ...
  const participationAndVenue = [
    ...
    { question: "What is the venue for the event?", answer: "The hackathon will be in hybrid mode and will be held at The North Cap University. Further details will be shared with you via email." },
  ];
